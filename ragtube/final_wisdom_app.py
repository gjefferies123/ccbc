#!/usr/bin/env python3
"""Final Biblical Wisdom App with correct Cohere models."""
...
class FinalBiblicalWisdomBot:
    """Biblical guidance bot with correct current Cohere models."""
    ...
    def _init_clients(self):
        ...
        try:
            ...
            logger.info("✅ Final Biblical Wisdom App ready")
    ...
    def get_biblical_guidance(self, 
        ...
        try:
            ...
            # Step 3: Generate biblical guidance using correct Cohere models
            guidance = self._generate_biblical_response_correct(user_question, context)
    ...
    def _generate_biblical_response_correct(self, question: str, sermon_context: str) -> str:
        """Generate biblical guidance using correct current Cohere models."""
        
        # Try multiple current model names
        models_to_try = ["c4ai-aya", "command-light", "command-nightly", "aya", "north"]
...
def main():
    """Test the final biblical wisdom app."""
    print("📖 FINAL BIBLICAL WISDOM APP")
    print("=" * 50)
    
    try:
        wisdom_bot = FinalBiblicalWisdomBot()
        ...
        print(f"\n✅ Final Biblical Wisdom App is working!")
        return True
